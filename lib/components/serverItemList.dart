...
class ServerItemList extends StatefulWidget {
  ...
  const ServerItemList ({ Key? key, required this.serverData }): super(key: key);

  @override
  _ServerItemListState createState() => _ServerItemListState();
}
...
class _ServerItemListState extends State<ServerItemList> {
